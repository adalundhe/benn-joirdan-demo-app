    ...
    return (
        <div className="w-full flex justify-center items-center pb-4">
            <button 
                ...
                className={`text-4xl px-4 py-4 dark:text-white text-slate-900 flex items-center justify-center ${buttonState === "ENABLED" ? "" : "cursor-not-allowed text-slate-300 text-[#b9b9b9] dark:text-[#ffffff]/20 dark:bg-[#24252a]"}`}
                onClick={() => {
