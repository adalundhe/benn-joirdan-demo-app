    ...
    return (
        <div className="w-full flex justify-center items-center pb-4">
            <button 
                ...
                className={`text-4xl px-4 py-4 dark:text-white text-slate-900 flex items-center justify-center ${buttonState === "ENABLED" ? "" : "cursor-not-allowed text-[#d3d3d3] dark:text-[#5a5a5a] dark:bg-[#24252a]"}`}
                onClick={() => {
